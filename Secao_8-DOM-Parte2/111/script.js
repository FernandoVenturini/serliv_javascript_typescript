...
console.log(link.parentElement); // Acessa o elemento pai do <a>

const list = document.querySelector('ul ul'); // Seleciona a segunda lista não ordenada
console.log(list.childNodes); // Acessa todos os nós filhos (incluindo nós de texto)
console.log(list.children); // Acessa apenas os elementos filhos 